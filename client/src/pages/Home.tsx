...
export default function Home() {
  ...
  const [uploadedTabularFiles, setUploadedTabularFiles] = useState<UploadedFile[]>([]);
  ...
  const [tabularOptions, setTabularOptions] = useState<TabularProcessingOptions>({
    missingValues: false,
    standardize: false,
      ...
      <main className="flex-grow w-full mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-dark-gradient min-h-screen">
        ...
        <section className="max-w-7xl mx-auto mb-20 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-float">
            <span className="text-gradient">Intelligent Data Preprocessing</span>
          </h1>
          <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
            Automate the preparation of your data for machine learning models with our powerful, AI-driven preprocessing tools.
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <div className="flex items-center px-4 py-2 bg-black/40 backdrop-blur-sm rounded-full border border-blue-800/50">
              ...
              <span className="text-gray-300 text-sm">Multiple file formats</span>
            </div>
            <div className="flex items-center px-4 py-2 bg-black/40 backdrop-blur-sm rounded-full border border-blue-800/50">
              <span className="w-2 h-2 bg-indigo-400 rounded-full mr-2"></span>
              <span className="text-gray-300 text-sm">AI-powered optimizations</span>
            </div>
            <div className="flex items-center px-4 py-2 bg-black/40 backdrop-blur-sm rounded-full border border-blue-800/50">
              <span className="w-2 h-2 bg-purple-400 rounded-full mr-2"></span>
              <span className="text-gray-300 text-sm">Customizable workflows</span>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto mb-20">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold mb-4 text-white">Upload Your Data</h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
              Upload images or tabular data for preprocessing with our advanced AI tools. We support multiple file formats for your convenience.
            </p>
          </div>
        ...
        <section className="max-w-7xl mx-auto mb-20">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold mb-4 text-white">Preprocessing Options</h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
              Configure the preprocessing techniques to apply to your data. Customize the workflows to meet your specific needs.
            </p>
          </div>
          ...
          <div className="mt-10 flex justify-center">
            <Button 
              ...
              disabled={processDataMutation.isPending || (uploadedImages.length === 0 && uploadedTabularFiles.length === 0)}
            >
              Process Data
            </Button>
          </div>
